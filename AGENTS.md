# AGENTS — host
## Mission
Remote host daemon, resource/VRAM authority, command decoders, scheduler, vendor-neutral backend and frame return.

## Owned scope
session host, VRAM manager, cache service, RGPU_BACKEND, decoders, GPU scheduler, frame export

## Forbidden scope / special rules
Own remote resource/VRAM authority, decoder, scheduler and backend ABI. Validate untrusted input before vendor driver. Vendor-specific code stays behind backend interface.
